...
public final class GridBagHelper {
	 ...
	 */
	public static void addComponent(JPanel panel, Component c, int x, int y,
			int width, int height, int ipadx, int ipady, double weightx,
		...
		addComponent(panel, c, x, y, width, height, ipadx, ipady, dx, dy,
	 ...
	 *            wird
	 * @param dx
	 *            Horizontaler Abstand zu Nachbarkomponenten in Pixeln
	 * @param dy
	 *            Vertikaler Abstand zu Nachbarkomponenten in Pixeln
	 * @param weightx
	 *            Mass fuer die zusaetzliche Flaeche in horizontaler Richtung
	 *            die dieser Komponente ggf. zur Verfuegung gestellt wird
	 * @param weighty
	 ...
	 */
	public static void addComponent(JPanel panel, Component c, int x, int y,
			int width, int height, int ipadx, int ipady, int dx, int dy,
